...
v2ray_install() {
    ...
    mkdir -p /root/v2ray
    cd /root/v2ray || exit
    wget -N --no-check-certificate https://raw.githubusercontent.com/damenly/V2Ray_ws-tls_bash_onekey/${github_branch}/v2ray.sh
...
domain_check() {
    ...
    local_ip=$(curl https://wtfismyip.com/text)
...
#}
acme_cron_update() {
    wget -N -P /usr/bin --no-check-certificate "https://raw.githubusercontent.com/damenly/V2Ray_ws-tls_bash_onekey/dev/ssl_update.sh"
...
update_sh() {
    ...
    if [[ "$shell_version" < "$(sort -rV $version_cmp | head -1)" ]]; then
        ...
        [yY][eE][sS] | [yY])
            wget -N --no-check-certificate https://raw.githubusercontent.com/damenly/V2Ray_ws-tls_bash_onekey/${github_branch}/install.sh
...
menu() {
    ...
    echo -e "\thttps://github.com/damenly\n"
    ...
    2)
        ...
        ;;
    3)
        bash <(curl -L -s https://raw.githubusercontent.com/damenly/V2Ray_ws-tls_bash_onekey/${github_branch}/v2ray.sh)
        ;;
    4)
